...
*/
package com.ugur.ui.renderers.factory;
...
import com.ugur.R;
import com.ugur.ui.renderers.renderer.PictureRenderer;

public class PictureFactory implements RendererFactory {

  @Override public Renderer getRenderer(int id) {
    switch (id) {
      case R.layout.adapter_image:
